...
def main(args):
    ...
    task_seq = [
        # The config for a task:  CNN Pets
        # acquire_method(sub_acquire_method): random(""), no-dete("DAL","BALD"), dete("coreset","entropy",...)
        # "../../datasets/answer_selection/YahooCQA/data/data-FD/"../../../../home/zyc/datasets/answer_selection/YahooCQA/data/data-FD
        #No-Deterministic
...

        {
            ...
            "sample_method": "No-Deterministic+DAL_evidence10+0",
        },
        {
            "model_name": "BiLSTM",
            "group_name": "[tkde]BiLSTM+Pets+MRR+160+160",
            ...
            "sample_method": "No-Deterministic+DAL_evidence10+16",
        },
        {
            "model_name": "BiLSTM",
            "group_name": "[tkde]BiLSTM+Pets+MRR+160+160",
            ...
            "sample_method": "No-Deterministic+DAL_evidence10+32",
        },
        {
            "model_name": "BiLSTM",
            "group_name": "[tkde]BiLSTM+Pets+MRR+160+160",
            ...
            "sample_method": "No-Deterministic+DAL_evidence10+64",
        },
        {
            "model_name": "BiLSTM",
            "group_name": "[tkde]BiLSTM+Pets+MRR+160+160",
            ...
            "sample_method": "No-Deterministic+DAL_evidence10+128",
        },

        {
            ...
            "acquire_question_num_per_round": 32,
            "warm_start_random_seed": 0,
            "sample_method": "No-Deterministic+DAL_evidence5+0",
        },
        {
            "model_name": "BiLSTM",
            "group_name": "[tkde]BiLSTM+Pets+MRR+160+160",
            ...
            "acquire_question_num_per_round": 32,
            "warm_start_random_seed": 16,
            "sample_method": "No-Deterministic+DAL_evidence5+16",
        },
        {
            "model_name": "BiLSTM",
            "group_name": "[tkde]BiLSTM+Pets+MRR+160+160",
            ...
            "acquire_question_num_per_round": 32,
            "warm_start_random_seed": 32,
            "sample_method": "No-Deterministic+DAL_evidence5+32",
        },
        {
            "model_name": "BiLSTM",
            "group_name": "[tkde]BiLSTM+Pets+MRR+160+160",
            ...
            "acquire_question_num_per_round": 32,
            "warm_start_random_seed": 64,
            "sample_method": "No-Deterministic+DAL_evidence5+64",
        },
        {
            "model_name": "BiLSTM",
            "group_name": "[tkde]BiLSTM+Pets+MRR+160+160",
            ...
            "acquire_question_num_per_round": 32,
            "warm_start_random_seed": 128,
            "sample_method": "No-Deterministic+DAL_evidence5+128",
        },

        {
            ...
            "acquire_question_num_per_round": 32,
            "warm_start_random_seed": 0,
            "sample_method": "No-Deterministic+DAL_evidence3+0",
        },
        {
            "model_name": "BiLSTM",
            "group_name": "[tkde]BiLSTM+Pets+MRR+160+160",
            ...
            "acquire_question_num_per_round": 32,
            "warm_start_random_seed": 16,
            "sample_method": "No-Deterministic+DAL_evidence3+16",
        },
        {
            "model_name": "BiLSTM",
            "group_name": "[tkde]BiLSTM+Pets+MRR+160+160",
            ...
            "acquire_question_num_per_round": 32,
            "warm_start_random_seed": 32,
            "sample_method": "No-Deterministic+DAL_evidence3+32",
        },
        {
            "model_name": "BiLSTM",
            "group_name": "[tkde]BiLSTM+Pets+MRR+160+160",
            ...
            "acquire_question_num_per_round": 32,
            "warm_start_random_seed": 64,
            "sample_method": "No-Deterministic+DAL_evidence3+64",
        },
        {
            "model_name": "BiLSTM",
            "group_name": "[tkde]BiLSTM+Pets+MRR+160+160",
            ...
            "acquire_question_num_per_round": 32,
            "warm_start_random_seed": 128,
            "sample_method": "No-Deterministic+DAL_evidence3+128",
        },
        # {
        #     "model_name": "CNN",
        #     "group_name": "[tkde]CNN+FD+MRR+320+320",
        #     "max_performance": 0.80,
        #     "data_path": "../../datasets/answer_selection/YahooCQA/data/data-FD/",
        #     "acquire_method": "no-dete",
        ...
        #     "warm_start_random_seed": 0,
        #     "sample_method": "No-Deterministic+DAL_2submodular1.5+0",
        # },

        # {
        #     "model_name": "BiLSTM",
        #     "group_name": "[tkde]BiLSTM+Pets+MRR+80+80",
        #     "max_performance": 0.80,
        #     "data_path": "../../datasets/answer_selection/YahooCQA/data/data-Pets/",
        #     "acquire_method": "no-dete",
        #     "sub_acquire_method": "DAL",
        ...
        #     "warm_start_random_seed": 128,
        #     "sample_method": "No-Deterministic+DAL_diversity1.5+128",
        # },
