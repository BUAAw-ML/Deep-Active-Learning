...
def main(args):
    ...
    task_seq = [
        ...
        },
        {
            ...
            "sample_method": "No-Deterministic+BALD_evidenc1.5+16",
        },
        {
            "model_name": "BiLSTM",
            "group_name": "[tkde]BiLSTM+Pets+MRR+160+160",
            ...
            "sample_method": "No-Deterministic+BALD_evidenc1.5+32",
        },
        {
            "model_name": "BiLSTM",
            "group_name": "[tkde]BiLSTM+Pets+MRR+160+160",
            ...
            "sample_method": "No-Deterministic+BALD_evidenc1.5+64",
        },
        {
            "model_name": "BiLSTM",
            "group_name": "[tkde]BiLSTM+Pets+MRR+160+160",
            ...
            "sample_method": "No-Deterministic+BALD_evidenc1.5+128",
        },
